...
export function FindPointsInsideAllConvexPolygons(
    ...
    // return FindPointsInsideAllConvexPolygonsReverseOrder(
    //     grid,
    //     visibleGridsMatrix,
    // );
    return new Set(
        uniqBy(
            [
                ...FindPointsInsideAllConvexPolygonsForwardOrder(
                    grid,
                    visibleGridsMatrix,
                ),
                ...FindPointsInsideAllConvexPolygonsReverseOrder(
                    grid,
                    visibleGridsMatrix,
                ),
            ],
 ...
 * @returns 被所有凸多边形包围的点的坐标数组
 */
export function FindPointsInsideAllConvexPolygonsForwardOrder(
    grid: GridMap,
    visibleGridsMatrix: boolean[][][][],
): Iterable<[number, number]> {
    // console.log(grid);
 ...
 * @returns 被所有凸多边形包围的点的坐标数组
 */
export function FindPointsInsideAllConvexPolygonsReverseOrder(
    grid: GridMap,
    visibleGridsMatrix: boolean[][][][],
): Iterable<[number, number]> {
    // console.log(grid);
